    ...
    <div className="select-option">
      <div className="select-option-item">
        ...
        <div className="select-option-item-body">
          <p>$29</p>
          <span>
            Enjoy Discount all types of <br />
            Grocery & frozen item
          </span>
        </div>
        <div className="select-option-item-footer">
          <img
            src={ImgFooter_item1}
            alt="select-option-footer"
            className="imgFooter1"
          />
          <img
            src={ImgFooter_item11}
            alt="select-option-footer"
            className="imgFooter2"
          />
          <img
            src={ImgFooter_item13}
            alt="select-option-footer"
            className="imgFooter4"
          />
          <img
            src={ImgFooter_item12}
            alt="select-option-footer"
      ...
      <div className="select-option-item">
        ...
        <div className="select-option-item-footer">
          ...
          />
          <img
            src={ImgFooter_item21}
            alt="select-option-footer"
            className="imgFooter2"
          />
          <img
            src={ImgFooter_item23}
            alt="select-option-footer"
            className="imgFooter4"
          />
          <img
            src={ImgFooter_item22}
            alt="select-option-footer"
            className="imgFooter3"
          />
        </div>
      ...
      <div className="select-option-item">
        ...
        <div className="select-option-item-footer">
          ...
          />
          <img
            src={ImgFooter_item31}
            alt="select-option-footer"
            className="imgFooter2"
          />
          <img
            src={ImgFooter_item33}
            alt="select-option-footer"
            className="imgFooter4"
          />
          <img
            src={ImgFooter_item32}
            alt="select-option-footer"
            className="imgFooter3"
          />
        </div>
      ...
      <div className="select-option-item">
        ...
        <div className="select-option-item-footer">
          ...
          />
          <img
            src={ImgFooter_item41}
            alt="select-option-footer"
            className="imgFooter2"
          />
          <img
            src={ImgFooter_item42}
            alt="select-option-footer"
            className="imgFooter3"
          />
        </div>
