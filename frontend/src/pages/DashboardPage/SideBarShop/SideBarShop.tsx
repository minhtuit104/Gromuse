  ...
  return (
    ...
    >
      ...
      <div className="sidebar_body">
        <ul>
            <li><img src={IconDash} alt="dashboard" className="ic_24"/> Dashboard</li>
            <li><img src={IconProduct} alt="product" className="ic_24" /> Products</li>
            <li><img src={IconDiscount} alt="discount" className="ic_24" /> Discounts</li>
            <li><img src={IconPhone} alt="phone" className="ic_24" /> Support</li>
        </ul>
      </div>
    </Drawer>
  );
