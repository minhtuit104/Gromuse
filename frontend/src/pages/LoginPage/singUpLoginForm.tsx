...
const SignUpLogInForm: React.FC = () => {
    ...
    const handleEmailChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        } else if (!/^[a-zA-Z0-9._-]+@gmail\.com$/.test(value) && !/^\d{9,15}$/.test(value)){
    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        try {
            let res = await registerApi(formData.name, formData.email, formData.phoneNumber, formData.password);
    ...
    return (
        ...
        <div className={`container ${isRegistering ? 'active' : ''}`}>
            ...
            <div className="form-box login">
                <form action="#" onSubmit={handleLogin}>
                    ...
                    <div className="input-box">
                        ...
                        />
                        <img 
                            src={isShowPassword ? IconEye: IconLockEye} alt="password" className='ic_20 icon-user-pass'
            ...
            <div className="form-box register">
                ...
                <div className="input-box">
                    <input type="email" name='email' placeholder="Email" value={formData.email} onChange={handleRegisterChange} />
                    <img src={IconEmail} alt="user" className='ic_20 icon-user-pass'/>
                    {errors.email && (
                        <div className="error-message">
                            <img src={IconError} alt="error" className="ic-error" />
                                {errors.email}
                ...
                <div className="input-box">
                    <input type="phonenumber" name='phoneNumber' placeholder="Phone number" value={formData.phoneNumber} onChange={handleRegisterChange} />
                    <img src={IconPhone} alt="user" className='ic_20 icon-user-pass'/>
                    {errors.phoneNumber && (
                        <div className="error-message">
                            <img src={IconError} alt="error" className="ic-error" />
                                {errors.phoneNumber}
                ...
                <div className="input-box">
                    <input type="password" name='password' placeholder="Password" value={formData.password} onChange={handleRegisterChange} />
                    <img src={IconLockpass} alt="user" className='ic_20 icon-user-pass'/>
                    {errors.password && (
                        <div className="error-message">
                            <img src={IconError} alt="error" className="ic-error" />
                                {errors.password}
