...
const LoginShop = () => {
    ...
    const handleRegister = async (values: RegisterFormValues, {resetForm}: any) => {
        try {
            let res = await registerApiShop(values.name, values.email, values.phoneNumber, values.password, values.address);
            if(res && res.status === 400){
                toast.error(res.data.message.message);            
            } else {
                            ...
                            {({ values, handleSubmit, handleChange, handleBlur, touched, errors }) => (
                                <form onSubmit={handleSubmit} className="form-login">
                                    ...
                                    <div className="registerLink">
                                        <p>You don't have account? <a href="#register" className="register" onClick={registerLink}>Sing up</a></p>
                                    </div>
                ...
                {/* Form đăng kí */}
                    <div className="form-boxx register">
                        ...
                        <Formik<RegisterFormValues>
                            initialValues={{ name: "", phoneNumber: "", email: "", address: "", password: "" }}
                        ...
                        >
                            {({ values, handleSubmit, handleChange, handleBlur, touched, errors }) => (
                                <form onSubmit={handleSubmit} className="form-register">
                                    ...
                                    <div className="registerLink">
                                        <p>You have account? <a href="#" className="register" onClick={loginLink}>Login</a></p>
                                    </div>

                                    <button type="submit" className="login">Sing up</button>
